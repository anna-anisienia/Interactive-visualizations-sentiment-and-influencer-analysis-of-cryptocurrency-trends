...
#______________________________________________________________________________
### Preprocessing for the map - Sara
#______________________________________________________________________________
...
#______________________________________________________________________________
# Preprocessing for the NER = Named Entity Recognition - Irina
#______________________________________________________________________________
import pickle
...
# Sentiment grouped
                ...
                html.H2("Where can we pay by using Bitcoin and Ethereum? Where can we find an ATM and where are the Mining pools located? Let's find out."),
                            dcc.Graph(id='map5',
                                figure = {'data':[
                                    go.Scattermapbox(
